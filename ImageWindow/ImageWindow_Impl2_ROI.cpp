...
void CImageWindow_Impl2::uDrawROIs(CDC* pDC)
{
...
void CImageWindow_Impl2::uDrawROI(CDC* pDC, const CROIDrawBase* pROIDraw)
{
	if( !pROIDraw ) return;
...
CROIGeometryBase* CImageWindow_Impl2::GetROIGeometry(long nIndex)
{
...
void CImageWindow_Impl2::uDrawROIEditor(CDC* pDC, CROIEditBase* pROIEdit)
{
	if( !pROIEdit ) return;
...
BOOL CImageWindow_Impl2::IsROIEditMode() const
{
	return m_bROIEditMode;
}

int  CImageWindow_Impl2::FindROI(const CPoint& pos)
{
	for(long i = (long)m_vecROIGeo.size() - 1 ; i >= 0 ; --i)
	{
...
////////////////////////////////////////////////////////////////////////////////////////////////
int CImageWindow_Impl2::GetMinimumDistance( CPoint cp, const EditROI& roi  )
{
...
////////////////////////////////////////////////////////////////////////////////////////////////
int CImageWindow_Impl2::GetDirection( CPoint cp, CRect &rt, BOOL isResizable, BOOL isMovable )
{
	int nd[4];
...
void CImageWindow_Impl2::ROICursorChange( int nROI_Dir )
{
	switch(nROI_Dir){
		case ROI_MOVE:
...
void CImageWindow_Impl2::ROIEditMode(int nROI_Dir)
{
	switch(nROI_Dir)
	{
		case ROI_MOVE:
...
/////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////
void  CImageWindow_Impl2::uUpdateROI( int nSelected, CPoint cp )
{
	ASSERT(0);
