...
class CImageWindow_Impl2 : public CDialog
{
	HCURSOR hCursorPrv;
	ULONG_PTR token;
...
public:
	CImageWindow_Impl2(CImageWindowEvt *pHandler, CWnd* pParent = NULL);
	~CImageWindow_Impl2();
...
private:
	...
	//---> 원섭 2005-11-23 [클릭했을경우 위치를 리턴할 수 있다.] //<--- 원섭
...
private:
	...
	//{{AFX_VIRTUAL(CImageWindow_Impl2)
protected:
...
private:	// TRACE
	...
	BOOL	__MakeSampledDIB(const CRect &rtDC, const CRect &rtOrgDIB, long nBpp, CRect &rtSampledDIB);
