...

void CImageWindow_Impl::uOverlayDrawAll(CDC *pDC, BOOL bDrawOverlay, BOOL bDrawCrossLine)
{
	FastDrawDCReady(pDC);
...
void CImageWindow_Impl::uDrawLine(CDC *pdc,CPoint pt1,CPoint pt2, COLORREF crColor)
{
	if( !pdc ) return;
...
void CImageWindow_Impl::uDrawRect(CDC *pdc,CRect rect)
{
...
void CImageWindow_Impl::uDrawRectFill(CDC *pdc,CRect rect, COLORREF clr )
{
	CRect o_Rect = ImageToScreenRect(rect);
...
void CImageWindow_Impl::uDrawPoly(CDC *pdc, const vector<CPoint>& vecPoint)
{
...
void CImageWindow_Impl::uDrawPolyFill(CDC *pdc, const vector<CPoint>& vecPoint, COLORREF clr)
{
	uDrawPoly(pdc, vecPoint);
}

void CImageWindow_Impl::uDrawText(CDC *pdc, float fX, float fY, LPCTSTR str)
{
...
void CImageWindow_Impl::uOverlayDrawLine(CFastDrawDC &dc, std::vector<Overlay::Line>& ArsLine)
{
	// 반복자를 사용하면 죽는다.. 왜????
	// 나중에 이유 찾을 것.
	// iVisionCal 에서 죽음..
...
void CImageWindow_Impl::uOverlayDrawRect(CFastDrawDC &dc, std::vector<Overlay::Rect>& ArsRect)
{	
...
void CImageWindow_Impl::uOverlayDrawEllipse(CFastDrawDC &dc, std::vector<Overlay::Ellipse>& ArsEllipse)
{
...
void CImageWindow_Impl::uOverlayDrawPoint(CFastDrawDC &dc, std::vector<Overlay::Point>& ArsPt)
{
...
void CImageWindow_Impl::uOverlayDrawText(CDC *pDC, std::vector<Overlay::Text>& ArsText)
{
	if(!ArsText.empty())
	{
...
void CImageWindow_Impl::FastDrawDCReady(CDC* pDC)
{
	__CSFastDrawDC.Lock();
	m_FastDC.Draw_Ready(pDC);

}
void CImageWindow_Impl::FastDrawDCExcute()
{
...
void CImageWindow_Impl::uOverlayDrawArcDoughnut(CFastDrawDC &dc, std::vector<Overlay::ArcDoughnut>& ArsArcDoughnut)
{
...
void CImageWindow_Impl::uOverlayDrawArcRing(CFastDrawDC &dc, std::vector<Overlay::ArcRing>& ArsArcRing)
{
	if(!ArsArcRing.empty())
	{
		CRect o_Rect(0, 0, 0, 0);
